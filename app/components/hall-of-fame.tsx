...
import type { Game, ScoreRow } from "@/lib/games-data";
...
export function HallOfFame({
  ...
  const you = user ? rows.find((r) => r.name === user.nickname) : undefined;
    ...
    <div className="av-hall fade-in">
      ...
      {rows.length === 0 ? (
        <div style={{ padding: 80, textAlign: "center", color: "var(--ink-faint)" }}>
          ...
          <div>Sé el primero en aparecer en el Salón de la Fama de {game.title}.</div>
        </div>
      ) : (
        <>
