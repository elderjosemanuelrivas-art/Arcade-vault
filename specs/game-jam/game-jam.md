...
- **Estado:** en spec (enfoque A elegido por el humano, promovido a `specs/10-galaga-real-en-invasores.md`)
...
- **Resultado:** enfoque A elegido (SPEC 10) — pendiente de implementación vía `/spec-impl`.
