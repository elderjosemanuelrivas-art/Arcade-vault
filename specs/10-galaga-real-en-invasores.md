# SPEC 10 — Galaga real en «invasores»
...
> **Date:** 2026-09-09
> **Origen:** promovido de `specs/game-jam/invasores/01-galaga-captura-y-nave-doble.md` (game jam, enfoque A «captura y nave doble», elegido por el humano sobre el enfoque hermano `specs/game-jam/invasores/02-galaga-vidas-limpias.md` — ver ambos y `specs/game-jam/game-jam.md` #001 para el razonamiento completo de la elección).
